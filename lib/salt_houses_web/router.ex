defmodule SaltHousesWeb.Router do
  use SaltHousesWeb, :router

  import SaltHousesWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {SaltHousesWeb.LayoutView, :root}
